...
This may lead to some false positives from the slashing prevention detection component (i.e., messages that are not actually slashable are identified as slashable). However, **the validator *WILL* lose out on rewards for a while because of inactivity.**
...
##### Validator Activity Implications
This may lead to some false positives from the slashing prevention detection component (i.e., messages that are not actually slashable are identified as slashable). However, **the validator *MAY* lose out on rewards for this epoch because of inactivity.**
